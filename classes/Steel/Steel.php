...
class Steel {
    ...
    private function set_mvc_map() {
        ...
        $this->mvcMap['translate'] = new \Steel\MVC\MVCIdentifier('MVC-TRANSLATE', 'translate', 'TranslateModel', 'TranslateView', 'TranslateController', array(), array());
        $this->mvcMap['about'] = new \Steel\MVC\MVCIdentifier('MVC-ABOUT', 'about', 'AboutModel', 'AboutView', 'IndexController', array(), array());
    }
